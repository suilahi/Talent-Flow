...
<head>
  ...
  <title>Créer une Offre - TalentFlow</title>
  ...
  <style>
    ...
    .create-container { background: white; padding: 40px; border-radius: 15px; box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.1); max-width: 500px; width: 100%; text-align: center; animation: fadeIn 1s ease-in-out; margin: auto; margin-top: 60px; }
    .create-container h1 { margin-bottom: 20px; font-weight: 600; color: #607D8B; }
    .form-control { border-radius: 10px; }
    .btn-create { background-color: #90CAF9; border: none; border-radius: 20px; padding: 10px; color: white; width: 100%; transition: background-color 0.3s, transform 0.3s; }
    .btn-create:hover { background-color: #42A5F5; transform: scale(1.05); }
